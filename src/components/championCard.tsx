    ...
    <div className="  w-full ">
      <div
        className={`shadow-md px-4 py-3 relative my-2 ${
          parseFloat(pickRate) > 49
            ? `w-1/2`
            : 'w-full md:w-1/2 lg:w-1/3 lg:grid-cols-12'
        }`}
      >
        ...
        <div className="pt-8 flex items-center gap-4 relative z-10 font-outfit text-white font-medium w-full ">
          <Image
        ...
        <div className="relative z-10 font-outfit text-white">
          <div className="flex flex-1 gap-2 pt-4">
            ...
            <span className="font-black ">
              {(Number(champion.kills) / Number(champion.totalGames)).toFixed(
                1
              )}
              &nbsp;/&nbsp;
              {(Number(champion.deaths) / Number(champion.totalGames)).toFixed(
                1
              )}
              &nbsp;/&nbsp;
